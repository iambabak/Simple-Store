...
describe('store integration', () => {
    ...
    test('async', () => __awaiter(this, void 0, void 0, function* () {
        const WrappedPage = withRedux(makeStore)(AsyncPage);
        yield verifyComponent(WrappedPage);
    }));
});
describe('client integration', () => {
    test('store taken from window', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield store.dispatch({ type: 'FOO', payload: 'foo' });
        yield verifyComponent(WrappedPage);
        delete global['window'];
    }));
    test('store not taken from window', () => __awaiter(this, void 0, void 0, function* () {
        global['window'] = {}; // nasty hackery
